...
export class DebugPanel {
  ...
  constructor() {
    ...
    const defs: SliderDef[] = [
      ...
      { key: 'gripFront', obj: T, min: 0.4, max: 4, step: 0.05 },
      { key: 'gripRear', obj: T, min: 0.4, max: 4, step: 0.05 },
      ...
      { key: 'cornerDrag', obj: T, min: 0, max: 2, step: 0.05 },
      ...
      { key: 'driftGripLoss', obj: T, min: 0, max: 0.7, step: 0.02 },
      ...
      { key: 'steerExpo', obj: T, min: 1, max: 3, step: 0.05 },
